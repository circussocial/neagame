...
{ ?>    
        <a href="javascript:;" onclick="document.location='index.php?r=neagame/default/settings&themeId=<?php echo $_REQUEST['themeId']; ?>&localAppId=<?php echo $_REQUEST['localAppId']; ?>'" class="buttonM bGreen"><span class="icon-arrow-left-3"></span><span>Back</span></a>
<?php }
else
{ ?>
