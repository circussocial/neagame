...
<a href="index.php?r=neagame/default/settings&tab=manageCategories&themeId=7&localAppId=24&uiTab=tabs-2" >tab2</a>
<br /><br /><br />


<a href="index.php?r=neagame/default/settings&tab=manageSharingMessages&themeId=7&localAppId=24&uiTab=tabs-5" >sharing msgs</a>
...
{ ?>    
        <a href="javascript:;" onclick="document.location='index.php?r=neagame/default/customizeTheme&themeId=<?php echo $_REQUEST['themeId']; ?>&localAppId=<?php echo $_REQUEST['localAppId']; ?>'" class="buttonM bGreen"><span class="icon-arrow-left-3"></span><span>Back</span></a>
<?php }
else
{ ?>
        <a href="javascript:;" onclick="document.location='index.php?r=neagame/default'" class="buttonM bGreen"><span class="icon-arrow-left-3"></span><span>Back</span></a>
<?php } ?>
...
<script>
	...
	if(gotoNext == 1)
	{
	    document.location = "index.php?r=neagame/default/publishing&themeId=<?php echo $_REQUEST['themeId']; ?>&localAppId=<?php echo $_REQUEST['localAppId']; ?>";
	}
    }
