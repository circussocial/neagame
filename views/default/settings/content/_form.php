...
if($action == "Delete")
{
    ...
    //sending to report
    $this->redirect("index.php?r=neagame/default/settings&tab=".$_GET['tab']."&themeId=".(int)$_REQUEST['themeId']."&localAppId=".(int)$_REQUEST['localAppId']."#tabs-3");
...
if (isset($_POST['Content']))
{
	...
	if ($model->save())
	{
        ...
        {
            $this->redirect("index.php?r=neagame/default/settings&tab=".$_GET['tab']."&themeId=".(int)$_REQUEST['themeId']."&localAppId=".(int)$_REQUEST['localAppId']."&subTab=create#tabs-3");
