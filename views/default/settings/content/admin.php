...
array(
	  ...
	  (
	    'update' => array
	    (
	     'url'=>'"index.php?r=neagame/default/settings&tab='.$_GET['tab'].'&themeId='.$_REQUEST['themeId'].'&localAppId='.$_REQUEST['localAppId'].'&subTab=create&nowAction=Update&id=$data->id#tabs-3"'
	    ),
