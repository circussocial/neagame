...
{
    NeagameSubmissions::model()->deleteByPk($_REQUEST['del']);
}




$model = new NeagameSubmissions();
...
$this->widget('zii.widgets.grid.CGridView', array(
	...
	'class'=>'IndexColumn',
	    ...
	    'header'=>'Delete',
	    'type'=>'raw',
	    'value'=>'"<a href=\"index.php?r=neagame/default/Reports&pageId='.$_REQUEST['pageId'].'&type=Entries&del=$data->id\" >Delete</a>"',
		 //'htmlOptions'=>array('width'=>'100px'),
	    ),
