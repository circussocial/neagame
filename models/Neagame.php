...
/**
 * This is the model class for table "tbl_neagame".
 *
 * The followings are the available columns in table 'tbl_neagame':
 * @property integer $id
 ...
 */
class Neagame extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return Neagame the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
		    'parent' => array(self::BELONGS_TO, 'Neagame', 'base_theme_id'),
		);
	}
	...
	function showFormImage($data)
	{
	    ...
	    echo '<img src="app_themes/neagame/'.@$data->parent->name.'/images/screenshot.png" width=80 /><br /><b>'.@$data->title.'</b>';
	}
	...
	function getNeagameEditLink($data)
	{
	    echo '<a href="index.php?r=neagame/default/customizeTheme&baseThemeId='.$data->base_theme_id.'&nowThemeId='.$data->id.'" >Edit</a>';
	}
	

	
	function getNeagameDeleteLink($data)
	{
	    echo '<a href="index.php?r=neagame/default&delForm='.$data->id.'" >Delete</a>';
	}
	
	
	function getNeagameSettingLink($data)
	{
	    echo '<a href="index.php?r=neagame/default/settings&tab=basic&baseThemeId='.$data->base_theme_id.'&nowThemeId='.$data->id.'" >Settings</a>';
	}
	...
	function getSubmissionReportsLink($data)
	{
	    ...
	    echo '<a href="index.php?r=neagame/default/submissionReports&tabId='.@$tabs->id.'" >Reports</a>';
	}
	...
	function getDownloadRecordsLink($data)
	{
	    ...
	    echo '<a href="index.php?r=neagame/default/DownloadCSV&pageId='.@$tabs->id.'" target="_blank" >Download</a>';
	}

	function getManageUsersLink($data)
	{
	    echo '<a href="index.php?r=neagame/default/manageAppUsers&appId='.$data->id.'&appName='.$data->title.'" >Manage</a>';
	}
